...
ssh-keygen -t rsa -b 4096 -C "$EMAIL" -f "/mnt/home/$USERNAME/.dotfiles/.ssh/id_rsa" -N ""
cp /mnt/home/$USERNAME/.dotfiles/.ssh/id_rsa.pub /mnt/home/$USERNAME/.dotfiles/hosts/$HOSTNAME
