      ...
      ruleset = ''
        table inet myfilter {
          ...
          chain output {
            ...
            oifname { "wg-vps2", "wg-vps" } tcp dport { 53, 853 } drop;
            oifname { "wg-vps2", "wg-vps" } udp dport { 53, 853 } drop;

            # Allow DNS ONLY via the wg-vps2 interface.
            oifname "enp3s0" tcp dport 53 accept;
            oifname "enp3s0" udp dport 53 accept;
