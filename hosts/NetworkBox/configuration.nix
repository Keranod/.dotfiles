      ...
      ruleset = ''
        ...
        table inet filter {
          ...
          chain forward {
            ...
            # 1. Allow traffic from your VPN devices to your LAN
            iifname "wg-devices" oifname "enp0s20u1c2" accept;
            
            # 2. Allow return traffic from your LAN to your VPN devices
            iifname "enp0s20u1c2" oifname "wg-devices" accept;

            # 3. Allow traffic from the VPS tunnel to the LAN
            iifname "wg-vps" oifname "enp0s20u1c2" accept;

            # 4. Allow traffic from the LAN to the VPS tunnel
            iifname "enp0s20u1c2" oifname "wg-vps" accept;

            # 5. Allow traffic from the VPS tunnel to the devices tunnel
            iifname "wg-vps" oifname "wg-devices" accept;
            
            # 6. Allow traffic from the devices tunnel to the VPS tunnel
